...
switchGPU uses a version of gfxCardStatus that accepts the mode you want to start the program in as a parameter. In this way, gfxCardStatus will always start in integrated GPU mode.
